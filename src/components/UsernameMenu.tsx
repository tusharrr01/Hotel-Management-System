...
import { Plus, LogOut, Building2, LayoutDashboard } from "lucide-react";
    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuContent align="end" className="w-56 bg-white p-2">
        <div className="px-2 py-1">
          ...
          {userRole && (
            <p className="text-xs text-primary-600 font-semibold capitalize">
              {userRole === "hotel_owner" ? "Hotel Owner" : userRole}
            </p>
          )}
        </div>
        <Separator className="my-2 bg-gray-200" />

        {/* Hotel Owner Menu Items */}
