...
const AnalyticsDashboard = () => {
  ...
  // Role-based access control - only hotel_owner and admin can access
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            Business Insights is only available for Hotel Owners and Administrators.
          </p>
          <p className="text-sm text-gray-500 mb-8">
            To unlock these analytics, please create a hotel to become a Hotel Owner.
          </p>
          <a
            href="/"
